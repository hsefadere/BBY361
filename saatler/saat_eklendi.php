<?php
    ...
    $FirmaSeriNo = mysqli_real_escape_string($baglanti, $_POST['FirmaSeriNo']);
    $UrunFiyat = mysqli_real_escape_string($baglanti, $_POST['UrunFiyat']);
    $UrunStok = mysqli_real_escape_string($baglanti, $_POST['UrunStok']);
    $sorgu = "INSERT INTO saat (UrunMarka, UrunAdi, FirmaIdNo, UrunFiyat, UrunStok)
            VALUES ('$UrunMarka', '$UrunAdi', '$FirmaSeriNo', '$UrunFiyat' ,'$UrunStok')";
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM saat ORDER BY SaatSeriNo DESC");
