<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["SaatSeriNo"]);
    $sorgu = "DELETE FROM saat WHERE SaatSeriNo = '$silinecek'";
...
<meta name="theme-color" content="#563d7c">
  ...
  "
>
  <h1 class="text-white">Ürün Silme</h1>
</div>
<div class="container">
<div class="row">
